...
namespace ShellProgressBar
{
  public class ProgressBar : IDisposable
  {
    ...
    private static int ConsoleWidth { get { return Console.LargestWindowWidth - 1; } }

    private static int ConsoleHeight { get { return Console.LargestWindowHeight - 1; } }
    ...
    private void DisplayProgress()
    {
      ...
      var column1width = ConsoleWidth == 0 ? 60 : ConsoleWidth - durationString.Length - 2;
    ...
    public static void OverwriteConsoleMessage(string message)
    {
      ...
      int maxCharacterWidth = ConsoleWidth;
      message = message + new string(' ', maxCharacterWidth - message.Length > 0 ? maxCharacterWidth - message.Length : 0);
